                        ...
                        <div class="lay4_wrap<?php if (!is_active_sidebar('sidebar')) { ?> no_sidebar<?php } ?>">
                            ...
                            <div class="author_div">
                                ...
                                <div class="author_right">
                                    ...
                                    <div class="fa-envelope" style="color:#a9a9a9"><a
                                            href="mailto:<?php echo get_the_author_meta("user_email"); ?>"
                                            class="meta_auth"
                                            style="font-family:Corbel"><i> Napísať e-mail </a></i></div>
                                    <?php
                                    global $wp_query;
                                    ...
                                    ?>
                                    <div class="fa-thumb-tack" style="color:#a9a9a9"><i style="font-family:Corbel">
                                            Príspevkov: <?php echo $post_count; ?> . </i></div>
