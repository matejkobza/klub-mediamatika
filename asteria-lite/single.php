						...
						<?php
                                if ($categories[0]->cat_ID == 7) { // audio
                                    ...
                                    <object width="640" height="360">
                                        ...
                                        <embed src="https://www.youtube.com/v/<?php echo $id; ?>?version=3" type="application/x-shockwave-flash" allowfullscreen="true" allowScriptAccess="always" width="640" height="360"></embed>
                                    </object>
                                    <?php
