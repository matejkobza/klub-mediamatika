...
body .header4 .logo h1, body .header4 .logo h2{font-family:'Cinzel Decorative'; font-weight:normal;}
.nivo-caption h3{font-family:'Cinzel Decorative'; font-weight:normal; font-size:60px!important;}
<?php } ?>
/*USER'S CUSTOM CSS---------------------------------------------------------*/
...
.logo h1 a, .logo h2 a, .ast_maintanace .logo h1 a{font-family:'<?php echo $logofont['font-family']; ?>';color:<?php echo $logofont['color']; ?>; font-weight:<?php echo $logofont['font-weight']; ?>!important;}
