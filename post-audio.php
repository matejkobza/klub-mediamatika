...
<!--POST INFO START-->
				...
				<!--POST META INFO START-->
                                <div class="single_metainfo" align="center">
                                    ...
                                    <?php } else { ?><div class="meta_comm"><?php comments_popup_link( __('0 Komentárov', 'asteria'), __('1 Komentár', 'asteria'), __('2 Komentáre', 'asteria'), __('3 Komentáre', 'asteria'), __('4 Komentáre', 'asteria'), __('% Komenárov', 'asteria'), '', __('Off' , 'asteria')); ?></div><?php } ?>
