...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="//platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>', 'dot'); ?><br />
        ...
        function setting_disable_unique_ip() {
            $options = get_option('dot_irecommendthis_settings');
            if (!isset($options['disable_unique_ip']))
                $options['disable_unique_ip'] = '0';
        ...
        function dot_content($content) {
            ...
            if ((is_home() || is_category() || is_tag() || is_author() || is_date() || is_search()) && $options['add_to_other'])
                $content .= $this->dot_recommend();
...
//shortcode
        ...
        function dot_recommended_top_posts($atts, $content = null) {
            ...
            if ($category != '') {
                $request .= " AND CATEGORY(post_cat) = '$category'";
            }
            ...
            foreach ($posts as $item) {
                ...
                while ($the_query->have_posts()) {
                    ...
                    $return .= '<div class="' . implode(" ", get_post_class()) . '" id="post-' . get_the_ID() . '">';
			
			ob_start();
                    switch ($category[0]->cat_ID) {
                        case 4: // fotografia 
                            include $_SERVER["DOCUMENT_ROOT"] . '/newweb/klub/wp-content/themes/asteria-lite/post-graphic.php';
                            break;
                        case 5: // grafika 
                            include $_SERVER["DOCUMENT_ROOT"] . '/newweb/klub/wp-content/themes/asteria-lite/post-graphic.php';
                            break;
                        case 6: // video 
                            include $_SERVER["DOCUMENT_ROOT"] . '/newweb/klub/wp-content/themes/asteria-lite/post-video.php';
                            break;
                        case 7: // audio 
                            include $_SERVER["DOCUMENT_ROOT"] . '/newweb/klub/wp-content/themes/asteria-lite/post-audio.php';
                            break;
                        case 8: // web 
                            include $_SERVER["DOCUMENT_ROOT"] . '/newweb/klub/wp-content/themes/asteria-lite/post-graphic.php';
                            break;
                        case 9: // text 
                            include $_SERVER["DOCUMENT_ROOT"] . '/newweb/klub/wp-content/themes/asteria-lite/post-text.php';
                            break;
                        case 76: // sutaz 
                            include $_SERVER["DOCUMENT_ROOT"] . '/newweb/klub/wp-content/themes/asteria-lite/post-graphic.php';
                            break;
